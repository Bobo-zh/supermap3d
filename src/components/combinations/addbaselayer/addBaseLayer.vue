<template>
  <div class="myWidgetContainer" v-show="baseLayerShow" style="height: 100%;">
    <div class="contentHeader">
      <span>{{Resource.setBaseLayer}}</span>
      <span  class="closeBtn"  @click="toggleVisibility">&times;</span>
    </div>
    <div class="contentBody" style="padding: 0">
      <div  class="imageBaseLayer" style="flex: 1;background:rgba(35,35,35,0.8);">
