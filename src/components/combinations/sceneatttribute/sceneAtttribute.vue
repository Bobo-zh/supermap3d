<template>
  <div class="myWidgetContainer" v-show="SceneAtttributeShow" >
    <div class="contentHeader">
      <span>{{Resource.sceneOptions}}</span>
      <span   class="closeBtn"  @click="toggleVisibility">&times;</span>
    </div>
    <div class="contentBody" id="SceneAtttribute" data-attr="drag" style="padding: 0">
